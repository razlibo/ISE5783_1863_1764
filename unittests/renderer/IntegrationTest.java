...
public class IntegrationTest {
    ...
    public void sphereIntegrationTest(){
        ...
        assertEquals(2, sumAllIntersections(camera, new Sphere(1, new Point(0,0,-3))), "Wrong number of intersections");

        // TC02: Testing when the VP is inside the sphere
        camera = new Camera(new Point(0,0,0.5),new Vector(0,0,-1), new Vector(0,1,0));
        camera.setVPSize(3,3).setVPDistance(1);
        assertEquals(18, sumAllIntersections(camera, new Sphere(2.5, new Point(0,0,-2.5))), "Wrong number of intersections");

        // TC03: Testing when some of the VP is inside the sphere
        assertEquals(10, sumAllIntersections(camera, new Sphere(2, new Point(0,0,-2))), "Wrong number of intersections");

        // TC04: Testing when the VP and the camera are inside the sphere
        assertEquals(9, sumAllIntersections(camera, new Sphere(4, new Point(0,0,-2))), "Wrong number of intersections");

        // TC04: Testing when the VP and the camera are after the sphere
        assertEquals(0, sumAllIntersections(camera, new Sphere(0.5, new Point(0,0,1))), "Wrong number of intersections");
    }
    ...
    public void planeIntegrationTest(){
        ...
        assertEquals(9, sumAllIntersections(camera, new Plane(new Point(0,0,-3), new Point(8,7,-3), new Point(9,1,-3))), "Wrong number of intersections");

        // TC02: When the plane and the VP are not parallel but still there are 9 intersection points
        assertEquals(9, sumAllIntersections(camera, new Plane(new Point(0,0,-3), new Point(8,7,-3), new Point(9,-1,-4))), "Wrong number of intersections");

        // TC03: When the plane and the VP are not parallel but still there are 6 intersection points
        assertEquals(6, sumAllIntersections(camera, new Plane(new Point(0,0,-3), new Point(8,2,-3), new Point(9,-1,-8))), "Wrong number of intersections");
    }
    ...
    public void triangleIntegrationTest(){
        ...
        assertEquals(1, sumAllIntersections(camera, new Triangle(new Point(0,1,-2), new Point(-1,-1,-2), new Point(1,-1,-2))), "Wrong number of intersections");

        // TC02: Two intersection point
        assertEquals(2, sumAllIntersections(camera, new Triangle(new Point(0,20,-2), new Point(-1,-1,-2), new Point(1,-1,-2))), "Wrong number of intersections");
     ...
     */
    private int sumAllIntersections(Camera camera, Intersectable intersectable){
        int counter = 0;
        for (int i = 0; i< 3; i++){
            for (int j = 0; j< 3; j++){
